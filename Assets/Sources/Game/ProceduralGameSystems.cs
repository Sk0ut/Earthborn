public sealed class ProceduralGameSystems : Feature
{
	public ProceduralGameSystems(Contexts contexts) : base("Procedural Game Systems")
	{
		Add(new InitializeGameSystem(contexts));
		Add(new GeneratedMapSystem(contexts));
