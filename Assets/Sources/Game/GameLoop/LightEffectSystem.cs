...
public class LightEffectSystem : ReactiveSystem<GameEntity>
{
	...
	{
		return entity.turnState.value == TurnState.StartTurn
	...
	protected override void Execute (System.Collections.Generic.List<GameEntity> entities)
	{
		...
		player.health.value += iluminated(player) ? _gameContext.globals.value.HealthIncreasePerTurn : -_gameContext.globals.value.HealthDecreasePerTurn;
